...
$sql = "SELECT teacherID, name, email, photo_url, department, password, phone_number FROM teachers WHERE teacherID = ?";
...
if ($result->num_rows > 0) {
   ...
   if ($result->num_rows > 0) {
      ...
      echo "No department found for the given teacher.";
   }
