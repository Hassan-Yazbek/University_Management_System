...
$AdminID = $_SESSION['admin-id']; // Retrieve admin_id from session
...
$sql = "SELECT name,photo_url FROM admin WHERE `admin-id` = $AdminID";
         ...
         <nav id="sidebar">
            <div class="sidebar_blog_1">
               ...
               <div class="sidebar-header">
                  <div class="logo_section">
                     <a href="../dist/AdminCP.php"><img class="logo_icon img-responsive" src="../Pictures\R (1).png"
                           alt="#" /></a>
                  </div>
               </div>
            ...
            <div class="sidebar_blog_2">
               ...
               <ul class="list-unstyled components">
                  ...
                  <li><a href="../dist/widget.html"><i class="fa fa-clock-o orange_color"></i> <span>Widgets</span></a>
                  </li>
                  <li>
                  ...
                  <li><a href="tables.html"><i class="fa fa-table purple_color2"></i> <span>Schedules</span></a></li>
                  <li>
                     ...
                     <ul class="collapse list-unstyled" id="apps">
                        <li><a href="../dist/email.html">> <span>Email</span></a></li>
                        <li><a href="../dist/calendar.html">> <span>Calendar</span></a></li>
                        <li><a href="../dist/media_gallery.html">> <span>Media Gallery</span></a></li>
                     </ul>
                  </li>
                  <li>
                     <a href="contact.html">
                  ...
                  <li class="active">
                     <a href="#additional_page" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i
                           class="fa fa-clone yellow_color"></i> <span>Related Pages</span></a>
                  ...
                  <li><a href="../dist/map.html"><i class="fa fa-map purple_color2"></i> <span>Map</span></a></li>
                  <li><a href="../dist/Settings.php"><i class="fa fa-cog yellow_color"></i> <span>Settings</span></a>
                  </li>
               </ul>
            </div>
         </nav>
                           ...
                           <ul class="user_profile_dd">
                              <li>
                                 <a class="dropdown-toggle" data-toggle="dropdown"><img
                                       class="img-responsive rounded-circle" src="<?php echo $profile_photo; ?>" alt="#" /><span
                                       class="name_user"><?php echo $UserName; ?></span></a>
                                 <div class="dropdown-menu">
                                    <a class="dropdown-item" href="../dist/profile.php">My Profile</a>
                                    <a class="dropdown-item" href="../dist/Settings.php">Settings</a>
